        ...
        <form class="" method="POST" action="{{ route($link.'.update', $record->id) }} ">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <textarea id="my-editor" class="customeditor" name="description" placeholder="Place some text here" >{{ $record->description }}</textarea>
                    ...
                    <div class="controls">
                        ...
                        @if(isset($record->image) && $record->file != '')
                            <div id="filearea">
                                ...
                                <button type="button" class="text-danger deletefile"><i class="fa fa-remove"></i></button>
                            </div>
                        @else
                            <p>No File</p>
                        @endif
