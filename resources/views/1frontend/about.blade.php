...
<!--/grids-->
      <div class="agile_last_double_sectionw3ls">
          ...
          <a href="womens.html"><img src="{{ asset('frontend/images/bot_1.jpg') }}" alt=" "><h4>Flat <span>50%</span> offer</h4></a>
          
      </div>
       <div class="col-md-6 multi-gd-img multi-gd-text ">
          <a href="womens.html"><img src="{{ asset('frontend/images/bot_2.jpg') }}" alt=" "><h4>Flat <span>50%</span> offer</h4></a>
      </div>
      <div class="clearfix"></div>
     </div>             
<!--/grids-->
